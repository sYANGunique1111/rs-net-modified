...
def print_error(data_type,action_error_sum,show_protocol2=False,epoch=0,logger=None, lr = 0):
...
def print_error_action(action_error_sum, show_protocol2=False,epoch=0,logger=None, lr = 0):
    ...
    if show_protocol2 :
        ...
        logger.append([epoch, lr, mean_error_all['p1'].avg, mean_error_all['p2'].avg])
    else:
        ...
        logger.append([epoch, lr, mean_error_all['p1'].avg])
