...
class opts():
    ...
    def init(self):
        ...
        self.parser.add_argument('-l', '--num_layers', default=4, type=int, metavar='N', help='num of residual layers')
        ...
        self.parser.add_argument('--model_doc', type=str, default='rsnet', help='current model document name')
        ...
        self.parser.add_argument('--device', type=str, default='cuda', help='xyz/uvd/post/time')

        self.parser.add_argument('--post_refine', action='store_true', help='if use post_refine model')
        self.parser.add_argument('--rsnet_reload', type=int, default=0, help='if continue from last time')
        self.parser.add_argument('--post_refine_reload', type=int, default=0, help='if continue from last time')
        self.parser.add_argument('--previous_dir', type=str,default='./checkpoint', help='previous output folder')
        self.parser.add_argument('--rsnet_model', type=str, default='model_rsnet_2_eva_post_4704.pth', help='model name')
